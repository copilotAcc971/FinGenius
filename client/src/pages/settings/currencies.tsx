...
import { AddCurrencyDialog } from '@/components/currencies/add-currency-dialog';
import { ManualRateEntryDialog } from '@/components/currencies/manual-rate-entry-dialog';
import { ExchangeRateHistoryTable } from '@/components/currencies/exchange-rate-history-table';
